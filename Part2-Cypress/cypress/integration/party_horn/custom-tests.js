describe('Party Horn Tests', () => {
  ...
  it('volume image changes when volume is increased', () => {
  ...
  it('honk button is disabled when the textbox input is an empty or non-number', () => {
  ...
  it('test if an error is shown when you type a number outside the given range', () => {
